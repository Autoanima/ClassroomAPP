...
window.MAP_DATA = {
  ...
  seatBox: { x0: 368, y0: 112, x1: 1448, y1: 1112 },  // 座位圖的範圍（只看教室；後面到後門為止）
  ...
  items: [
    ...
    // ── 黑板與講台 ──
    { id: 'board', name: '黑板、黑板溝、板擦機、講台', cls: 'tan', job: 'J01', stretch: true, seatShow: true, seatLabel: '講台', x: 626, y: 133, w: 580, h: 118, labelAt: [916, 205] },
  ...
  defaultSeats: {
    ...
    8: ['多15', '多16', '多17', '多18', '多08'],   // 8-5：羅偲倚（座號改為多08）
  },
  seatW: 80,
  seatH: 103,
  colLabelY: 316,
  ...
  pointCats: ['秩序', '整潔', '其他'],
  pointReasons: {
    minus: ['上課講話', '上課睡覺', '上課打電動', '遲到', '未帶課本', '服裝儀容', '使用手機', '未交作業', '未繳交：', '打掃不確實'],   // 結尾是「：」的會讓游標停在後面，接著打內容
    plus: ['熱心服務：', '協助班務：', '表現優良：', '主動打掃：', '比賽得獎：'],   // 加分一律要寫具體內容
  },
