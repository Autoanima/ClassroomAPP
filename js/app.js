...
(() => {
  ...
  // ── 分頁 ──
  const TABS = ['clean', 'points', 'seats', 'draw', 'shop', 'line', 'jobs', 'lunch', 'fund'];
  const tabHooks = {};
  const allowedTabs = () => (isGuest() ? ['draw', 'seats'] : isStudent() ? ['seats', 'clean', 'draw', 'shop', 'line', 'jobs', 'lunch', 'fund']
  ...
  const WATCH = ['index.html', 'sw.js','config.js', 'js/map-data.js', 'js/sel-engine.js', 'js/app.js', 'js/seats.js', 'js/points.js', 'js/draw.js', 'js/shop.js', 'js/line.js', 'js/board.js', 'js/mail.js', 'js/fund.js', 'js/lunch.js', 'css/style.css'];
